...
describe('author with the most blogs', () => {
    ...
    test('of a list with many blogs is the author with the most blogs', () => {
...
describe('author with the most likes', () => {
    ...
    test('when list has only one blog, is that author with likes from that one blog', () => {
    ...
    test('of a list with many blogs is the author with the most likes', () => {
